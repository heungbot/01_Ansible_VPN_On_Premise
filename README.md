...
프로젝트 소개 : 일부 물리 서버를 임대하여 운영 중인 상황에서, 원격 접속을 구현하지 않아 의미없이 반복되는 작업을 효율적으로 처리하기 위한 목적으로 시작되었습니다. 이를 위해 S2S VPN 서비스를 활용하여 Cloud서버에서 IDC로 Ansible Playbook을 적용하고, Terraform 모듈을 구성하여 인프라를 배포, 관리하는 것이 목표입니다.
...
[05. 핵심 서비스 소개 ](#-05-핵심-서비스-소개-)

[06. 구현 과정 ](#-06-구현-과정-)

[07. Ansible Playbook 실행 및 결과 ](#-07-ansible-playbook-실행-및-결과-)
