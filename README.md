...
프로젝트 소개 : 일부 물리 서버를 임대하여 운영 중인 상황에서, 원격 접속이 불가능한 문제의 해결과 반복적인 작업의 효율화 달성을 목적으로 시작되었습니다. 이를 위해 S2S VPN 서비스를 활용하여 Cloud서버에서 IDC로 Ansible Playbook을 적용하고, Terraform 모듈을 구성하여 인프라를 배포, 관리하는 것이 목표입니다.
